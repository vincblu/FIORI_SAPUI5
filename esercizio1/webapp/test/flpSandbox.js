		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#corsofioriesercizio1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"corsofioriesercizio1-display": {
								"semanticObject": "corsofioriesercizio1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=corso.fiori.esercizio1",
									"url": sap.ui.require.toUrl("corso/fiori/esercizio1")
								}
							}
						}
					}
