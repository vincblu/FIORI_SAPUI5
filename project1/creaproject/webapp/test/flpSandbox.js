		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#festinantelesson1creaproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"festinantelesson1creaproject-display": {
								"semanticObject": "festinantelesson1creaproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=festinante.lesson1.creaproject",
									"url": sap.ui.require.toUrl("festinante/lesson1/creaproject")
								}
							}
						}
					}
