		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#festinantecorsoesercizio2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"festinantecorsoesercizio2-display": {
								"semanticObject": "festinantecorsoesercizio2",
								"action": "display",
								"description": "Es. Creazione View",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=festinante.corso.esercizio2",
									"url": sap.ui.require.toUrl("festinante/corso/esercizio2")
								}
							}
						}
					}
