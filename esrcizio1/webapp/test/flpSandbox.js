		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#festinantelesson1esrcizio1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"festinantelesson1esrcizio1-display": {
								"semanticObject": "festinantelesson1esrcizio1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=festinante.lesson1.esrcizio1",
									"url": sap.ui.require.toUrl("festinante/lesson1/esrcizio1")
								}
							}
						}
					}
