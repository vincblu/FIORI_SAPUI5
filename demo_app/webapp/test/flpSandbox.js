		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#lutechdemofioridemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lutechdemofioridemoapp-display": {
								"semanticObject": "lutechdemofioridemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lutech.demo.fiori.demoapp",
									"url": sap.ui.require.toUrl("lutech/demo/fiori/demoapp")
								}
							}
						}
					}
