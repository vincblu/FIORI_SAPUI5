		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#corsofioriesercizio4esercizio4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"corsofioriesercizio4esercizio4-display": {
								"semanticObject": "corsofioriesercizio4esercizio4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=corsofiori.esercizio4.esercizio4",
									"url": sap.ui.require.toUrl("corsofiori/esercizio4/esercizio4")
								}
							}
						}
					}
