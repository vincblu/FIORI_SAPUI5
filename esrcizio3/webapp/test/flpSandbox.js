		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#festinantecorsofioriesrcizio3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"festinantecorsofioriesrcizio3-display": {
								"semanticObject": "festinantecorsofioriesrcizio3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=festinante.corsofiori.esrcizio3",
									"url": sap.ui.require.toUrl("festinante/corsofiori/esrcizio3")
								}
							}
						}
					}
